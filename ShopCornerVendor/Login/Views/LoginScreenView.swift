        ...
        VStack(spacing: 0) {
            NavigationView {
                VStack(spacing: 0) {
                    ...
                    contentView
                    NavigationLink(
                        destination: OTPVerificationScreenView(viewModel: .init(phoneNumber: viewModel.loginModel.countryCode + viewModel.loginModel.phoneNumber), phoneNumber: viewModel.loginModel.countryCode + viewModel.loginModel.phoneNumber),
